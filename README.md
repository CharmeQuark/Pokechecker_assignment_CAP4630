...
Two notebooks are contained in notebooks, one for training and one for evaluation. 
The data folder contains the folders for train and test, as well as csvs for labels.
